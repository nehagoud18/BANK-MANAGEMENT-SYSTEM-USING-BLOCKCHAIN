        ...
        <div id="templatemo_right_section">
          ...
          <h1>
            ...
            <%
					...
					String paramname=null,uname=null,pass=null,email=null,mno=null,addr=null,dob=null,gender=null,pincode=null,location=null,image=null,cloud=null,network=null,bin = "";
          ...
          <p class="style6 style1 style2">User Name Already Exist</p>
          <p class="style5">&nbsp;</p>
          <%
          ...
          <%
					  ...
					  int count1=0;
PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,location,dob,gender,pincode,status,image,count) values(?,?,?,?,?,?,?,?,?,?,?)");
						...
						{
						%>
          <p class="style6 style1 style2">Registered Successfully</p>
          <p>&nbsp; </p>
          <p>
            <%	
          ...
          <p align="left"><a href="user_login.jsp" class="style16">Back</a></p>
          <%
