...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style9 style10">Cyber Physical Customer Management for Internet of Robotic Things Enabled Banking</a></h1>
      </div>
      ...
      <div class="mainbar">
        <div class="article">
		  ...
		  <form name="s" action="U_Search.jsp" method="post" onSubmit="return valid()"  ons target="_top">   
                  ...
                  <Table align="center" style="margin:0 0 0 30px;">
                    ...
                    <tr>
                      <td COLSPAN="3"><div class="style2">
                        <div align="center" class="style13 style5">( Searching Datasets Based on  Geography,Gender,Exited)</div>
                      </div></td>
                    </tr>
                  </Table>
               </div>
	 				 ...
	 				 try
						{
								...
								while(rs8.next())
										{
									s1 = rs8.getString(2); // ID
									s2 = rs8.getString(6); // Geography
								    s3 = rs8.getString(7); // Gender
									s4 = rs8.getString(17); // Exited
               ...
               <p class="style4"> 
               <div align="center" ><strong><span class="style5">TID :</span> <span class="style8"><%=s1%></span> </strong>
                 </p>
</div>
             
                <p><div align="center" class="style5"><strong>View <a href="U_Search1.jsp?Tid=<%=s1%>">View Details</a></strong></div>
                </p>
                <p></p>
				<div>
			...
			<p>&nbsp;</p>
				...
				<%	}
                  ...
                  <div align="right"><a href="user_main.jsp">Back</a></div>
