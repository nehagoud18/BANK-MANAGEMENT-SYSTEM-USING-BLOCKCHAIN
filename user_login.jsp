...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1 class="style1"><a href="index.html" class="style1 style1">Cyber Physical Customer Management for Internet of Robotic Things Enabled Banking</a></h1>
      </div>
        <p>&nbsp;</p>
      <div class="menu_nav">
        <ul>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
          <h2 class="star" align="center"><span>User Log In </span></h2>
          <form name="s" action="Authentication.jsp?type=<%="user"%>" method="post" onSubmit="return valid()"  ons target="_top"><div align="center">
		  <table border="0" width="52%" height="150">
      <tr>
        <td height="25" colspan="2"><p align="center"><img src="images/ulogin.jpg" width="547" height="203" align="middle" /></p>
          </td>
        </tr>
      <tr>
  ...
  <input type="password"  name="pass" size="15"></td>
      ...
      <tr>
        ...
        <p align="center"><input type="submit"  value="Login" name="B1"> 
